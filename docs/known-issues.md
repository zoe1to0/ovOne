...
- Group files are contract/scaffold-only: group settings can show an empty file list and unavailable upload notice, but no real upload, file parsing, retrieval, deletion, prompt injection, or runtime file storage exists yet.
