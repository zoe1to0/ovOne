...
- Me Settings Linked AI shows a disconnect confirmation scaffold from Global AI Links and has deterministic cleanup and execution-contract scaffolds, but confirmed global disconnect mutation is not implemented yet.
