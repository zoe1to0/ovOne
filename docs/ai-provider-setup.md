...
- Real Chat Runtime v1 uses the bridge for active private/group chat sends. It can include bounded AI-scoped world memory for the responding AI, but it does not stream, inject group rules, inject group files, or expose API keys in client-visible state.
